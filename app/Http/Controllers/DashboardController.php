...
class DashboardController extends Controller {
    ...
    public function dashboard(){
        ...
        {  
			...
			//dd($targetCounts);
			foreach($targetCountValue as $index => $targetAmount)
			{
				$columnTarget[] = [
					'caseAgentName' => $targetDataValue[$index],
		...
		->with('province', $province)->with('district', $district)->with('columnTarget', $columnTarget);
		}
		//return view('main.dashboard')->with('targetCount', $targetCount);
    }
