...
Route::group(['middleware'=>['auth']], function () 
{
    ...
    Route::get('/home',[DashboardController::class, 'dashboard2'])->name('home');
    ...
    Route::post('/detailTarget', [TargetController::class, 'detailTarget2'])->name('detailTarget');
    Route::post('/getEvents', [TargetController::class, 'getEvents2'])->name('getEvents');
    Route::get('/getEvents', [TargetController::class, 'getEvents2'])->name('getEvents');
    ...
    Route::post('/newLog/{_id}',[LogController::class, 'newLog'])->name('newLog/{_id}');
    Route::get('/newLog/{_id}',[LogController::class, 'newLog'])->name('newLog/{_id}');
    Route::post('/addLog',[LogController::class, 'addLog2'])->name('addLog');
